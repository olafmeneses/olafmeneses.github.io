...
This post will serve as an introduction. We'll find out some interesting and fun facts from our first look into the data. But wait, there's more! The real fun is coming up in the next post [Ref: next post], which promises to be even more exciting and interesting (and colorful).

As an added bonus, I've created a Shiny app where you can visualize +3800 languages in an interactive 3D plot. I personally think it's awesome. Even though I called it a bonus, it's so cool that it could be the main result of this project. Check out the Shiny app here [Ref: shiny app]!
...
In this post, we didn't really address my initial question: could we compare languages by looking at their first N number names sorted alphabetically? The initial idea was to answer it in the following section, but, as I explained in the [Ref: #Motivation] section, I decided to include it in a different post. You can find it here: [Ref: next post]. It's way more interesting than this introductory post!

Moreover, I developed a Shiny app in which you get to visualize +3800 languages in an interactive 3D plot, which I think is pretty cool. You can have a look at it here [Ref: shiny app].

Hope you enjoyed this initial post where we had a sneak peek into the number names of many languages and some interesting facts.

You can leave a comment down below, subscribe to my newsletter or send me an email at [Ref include email] if you have any question. See you in the next post!

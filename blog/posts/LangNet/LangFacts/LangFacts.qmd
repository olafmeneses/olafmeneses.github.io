...
format:
  html:
    ...
    css: style.css
share:  
  permalink: "https://olafmeneses.github.io/blog/posts/LangNums/LangFacts/LangFacts.qmd"
---
...
In this post, we didn't really address my initial question: could we compare languages by looking at their first N number names sorted alphabetically? The initial idea was to answer it in the following section, but, as I explained at the beginning, I decided to include it in a different post. You can find it here: [From number names to language families](../LangClust/LangClust.qmd). It's way more interesting than this introductory post!

Moreover, I developed a Shiny app in which you get to visualize +3800 languages in an interactive 3D plot, which I think is pretty cool. You can have a look at it here: [https://olafmeneses.shinyapps.io/LangNet](https://olafmeneses.shinyapps.io/LangNet)
